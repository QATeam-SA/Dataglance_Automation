...
public class Basiccontrol {
	...
	public void signaturestep() throws InterruptedException {
	    try {
	        // Signature step
	        ...
	        WebElement signatureInput = wait
	            .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(prop.getProperty("signaturestep1"))));
	        ...
	        logger.error("Error occurred in signaturestep method: ", e);
	...
	public void stepinfo() throws InterruptedException {
	    try {
	        ...
	        WebElement sectionElement11 = wait
	            .until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop.getProperty("Section"))));
	        ...
	        throw e; // Optional: handle or re-throw
	    }
	}
	...
	public void Delaystep() throws InterruptedException {
	    try {
	        ...
	        WebElement sectionElement111 = wait
	            .until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop.getProperty("Section"))));
	...
	public void Timedstep() throws InterruptedException {
	    try {
	        ...
	        logger.error("Error occurred in Timedstep method: ", e);
	        throw e;
	    }
	}
	...
	public void Repeatstep() throws InterruptedException {
	    try {
	        ...
	        // Ensure sectionElement is defined before use
	        WebElement sectionElement = wait
	            .until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop.getProperty("Section"))));
	...
	public void Holdstep() throws InterruptedException {
	    try {
	        ...
	        // Define sectionElement before use
	        WebElement sectionElement = wait
	            .until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop.getProperty("Section"))));
	...
	public void Proceduresnippet() throws InterruptedException {
	    try {
	        ...
	        WebElement procBtn = wait
	            .until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Proceduresnippet"))));
	        procBtn.click();
	        ...
	        // Optional: Uncomment to type in Proceduresnippet1 input
	        // waitAndType(prop.getProperty("Proceduresnippet1"), "Proceduresnippet12");

	        // Wait for 25 seconds (consider replacing with a better wait)
	        Thread.sleep(25000);

	        // Define sectionElement111 before use
	        WebElement sectionElement111 = wait
	            .until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop.getProperty("Section"))));
	...
	public void Add() throws InterruptedException {
	    try {
	        ...
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Add")))).click();

	    } catch (Exception e) {
	        logger.error("Error occurred in Add method: ", e);
	        throw e;
	    }
	}
	...
	public void Warning() throws InterruptedException {
	    try {
	        Thread.sleep(25000);
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Warning")))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Warning method: ", e);
	        throw e;
	    }
	}
	...
	public void Caution() throws InterruptedException {
	    try {
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Caution")))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Caution method: ", e);
	        throw e;
	    }
	}
	...
	public void Note() throws InterruptedException {
	    try {
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Note")))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Note method: ", e);
	        throw e;
	    }
	}
	...
	public void Paragrapgh() throws InterruptedException {
	    try {
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Paragrapgh")))).click();
	    } catch (Exception e) {
	...
	public void Label() throws InterruptedException {
	    try {
	        Thread.sleep(5000);
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Label")))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Label method: ", e);
	        throw e;
	    }
	}
	...
	public void Formula() throws InterruptedException {
	    try {
	        Thread.sleep(5000);
	        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(prop.getProperty("Formula")))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Formula method: ", e);
	        throw e;
	    }
	}
	...
	public void Table() throws InterruptedException {
	    try {
	        Thread.sleep(2000);
	        driver.findElement(By.xpath(prop.getProperty("Table"))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Table method: ", e);
	        throw e;
	    }
	}
	...
	public void Row() throws InterruptedException {
	    try {
	        Thread.sleep(2000);
	        driver.findElement(By.xpath(prop.getProperty("Row"))).clear();
	        Thread.sleep(2000);
	        driver.findElement(By.xpath(prop.getProperty("Row"))).sendKeys("5");
	    } catch (Exception e) {
	        logger.error("Error occurred in Row method: ", e);
	        throw e;
	    }
	}
	...
	public void Ok() throws InterruptedException {
	    try {
	        ...
	        logger.error("Error occurred in Ok method: ", e);
	        throw e;
	    }
	}
	@Test(priority = 25, enabled = true)
	public void Columnbutton() throws InterruptedException {
	    try {
	        Thread.sleep(2000);
	        driver.findElement(By.xpath(prop.getProperty("Columnbutton"))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Columnbutton method: ", e);
	        throw e;
	    }
	}
	@Test(priority = 26, enabled = true)
	public void Datatypedropdown() throws InterruptedException {
	    try {
	        Thread.sleep(2000);
	        driver.findElement(By.xpath(prop.getProperty("Datatypedropdown"))).click();
	    } catch (Exception e) {
	        logger.error("Error occurred in Datatypedropdown method: ", e);
	        throw e;
	    }
	}
	...
	public void Textdataentry() throws InterruptedException {
	    try {
	        Thread.sleep(2000);
	        WebElement e =driver.findElement(By.xpath(prop.getProperty("Datatypedropdown")));
	...
	public void Column3() throws InterruptedException {
	  ...
	  InterruptedException { try {  driver.findElement(By.xpath(prop.getProperty("Column4"))).click();
      Thread.sleep(2000);
      WebElement e =driver.findElement(By.xpath(prop.getProperty("Datatypedropdown")));
      Select ss = new Select(e);
       Thread.sleep(2000);
	  ...
	  InterruptedException { try {
		  Thread.sleep(7000);WebElement e
	  =driver.findElement(By.xpath(prop.getProperty("Datatypedropdown"))); Select
 ...
 */
  ...
  WebElement e = driver.findElement(By.xpath(prop.getProperty("Datatypedropdown")));
 Select
  ss = new Select(e); Thread.sleep(2000); ss.selectByIndex(4);
  } catch
