...
public class Stepaction {
    ...
    private Properties prop = PropertiesFile.readPropertyFile("Stepaction.properties");
    ...
    private void scrollAndClick(String xpath) {
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", element);
			...
			public void stepaction() throws InterruptedException {
				...
				Thread.sleep(4500);
				JavascriptExecutor js = (JavascriptExecutor) driver;
				WebElement element = driver.findElement(By.xpath(prop.getProperty("Stepaction")));
				js.executeScript("arguments[0].scrollIntoView(true);", element);
				element.click();
				Thread.sleep(2500);
